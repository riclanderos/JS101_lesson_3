...
let number1 = 8;  // numbers.includes(8) => false
let number2 = 95; // numbers.includes(95) => true
...
[ 'Barney', 2 ] 
// Object.entries(flintstones).filter(barney => barney[0] === 'Barney').shift();

// Question 8. How would you check whether the objects assigned to variables numbers and table below are arrays?
let numbers = [1, 2, 3, 4]; // Array.isArray(numbers); => true
let table = { field1: 1, field2: 2, field3: 3, field4: 4 }; // Array.isArray(table); => false
